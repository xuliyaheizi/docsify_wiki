...
#修改简单密码
$ mysql> ALTER USER USER() IDENTIFIED BY 'zhulin0804';
#登录
$ mysql> mysql -uroot -p
```
...
<img src="https://knowledgeimagebed.oss-cn-hangzhou.aliyuncs.com/img/image-20220628192646082.png" alt="image-20220628192646082" width="67%;" />
